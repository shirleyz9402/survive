  ...
  gameContent.addEventListener('click', e => {
    ...
    fetch('http://localhost:4000/api/v1/players', {
      ...
      gameContent.innerHTML = `<audio loop autoplay>
        <source src="assets/music/Carpenter Brut - LEATHER TEETH - 01 Leather Teeth.mp3" type="audio/mpeg"></audio>`
      ...
      player.style.background = ` url(assets/images/VictimsAndVillagers.png) ${playerSpriteRender}`
